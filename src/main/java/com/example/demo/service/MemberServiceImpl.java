...
public class MemberServiceImpl implements MemberService {
    ...
    public Member add(String firstname, String lastname, String company,
        ...
        Member member = new Member( firstname, lastname, company,
                branch, address, companyposition, dateofbirth, dateofjoiningcompany);
        try {
    ...
    public List<Member> find(String firstname, String lastname, String company,
        ...
        try {
            memberRepository.findByFirstnameOrLastnameOrCompanyOrBranchOrAddressOrCompanypositionOrDateofbirthOrDateofjoiningcompany( firstname, lastname, company,
                    branch, address, companyposition, dateofbirth, dateofjoiningcompany).forEach(members::add);
        }
        catch (DataIntegrityViolationException exception) {
